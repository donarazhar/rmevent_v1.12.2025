...
@section('title', $category->name . ' - Artikel Ramadhan 1447 H')
        ...
        <div class="container mx-auto px-4">
                        ...
                        <article
                            ...
                            <a href="{{ route('posts.show', $post->slug) }}">
                                <div class="relative h-56 overflow-hidden">
                                    ...
                                    @if ($post->is_featured)
                                        <div
                                            class="absolute top-3 right-3 px-3 py-1 bg-yellow-400 text-gray-900 rounded-full text-xs font-bold">
                                            ⭐ Featured
                                        </div>
                                    @endif
                                </div>
                                <div class="p-6">
                                    ...
                                    {{-- Author --}}
                                    <div
                                        class="flex items-center gap-2 text-sm text-gray-600 pt-4 border-t border-gray-100">
                                        <div
            ...
            @else
                ...
                <div class="bg-white rounded-2xl shadow-lg p-12 text-center max-w-2xl mx-auto">
                    ...
                    <p class="text-gray-600 mb-6">Belum ada artikel dalam kategori ini.</p>
