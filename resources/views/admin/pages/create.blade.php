                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                <label for="slug" class="block text-sm font-semibold text-gray-700 mb-2">
                                    Slug <span class="text-gray-500 text-xs">(Auto-generated)</span>
                                </label>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                ...
                                <label class="flex items-start">
                                    ...
                                    <span class="ml-3">
                                        <span class="block text-sm font-semibold text-gray-700">Show in Navigation Menu</span>
                                        <span class="block text-xs text-gray-500">Display this page in the main website navigation</span>
                                    </span>
                                </label>
                                ...
                                <label class="flex items-start">
                                    ...
                                    <span class="ml-3">
                                        ...
                                        <span class="block text-xs text-gray-500">Use this page as the site's homepage (will override current homepage)</span>
                                    </span>
                                </label>
                            </div>
                        </div>
