{{-- resources/views/admin/jobdescs/create.blade.php --}}

@extends('admin.layouts.app')

@section('title', 'Tambah Job Description')
...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Job Description</h1>
                <p class="text-sm text-gray-600 mt-1">Buat deskripsi pekerjaan baru untuk panitia</p>
            </div>
        ...
        {{-- Form --}}
        <form action="{{ route('admin.jobdescs.store') }}" method="POST" class="space-y-6" x-data="jobDescForm()">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required
                            placeholder="Contoh: Koordinator Acara Utama"
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="space-y-3" id="responsibilities-container">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="estimated_hours" id="estimated_hours" min="1"
                            value="{{ old('estimated_hours') }}" placeholder="Contoh: 40"
                    ...
                    <div>
                        ...
                        <select name="workload_level" id="workload_level" required
                            ...
                            <option value="ringan" {{ old('workload_level') == 'ringan' ? 'selected' : '' }}>Ringan
                            </option>
                            <option value="sedang" {{ old('workload_level') == 'sedang' ? 'selected' : '' }}>Sedang
                            </option>
                            <option value="berat" {{ old('workload_level') == 'berat' ? 'selected' : '' }}>Berat</option>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="priority" id="priority" required
                            ...
                            <option value="kritis" {{ old('priority') == 'kritis' ? 'selected' : '' }}>Kritis</option>
                        </select>
                        @error('priority')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="required_members" id="required_members" min="1"
                            value="{{ old('required_members', 1) }}" required
