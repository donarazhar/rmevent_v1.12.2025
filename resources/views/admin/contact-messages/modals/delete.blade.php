    ...
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
        ...
        <div class="flex items-center justify-between p-6 border-b border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <h3 class="text-xl font-semibold text-gray-900">Hapus Pesan</h3>
            </div>
        ...
        <div class="p-6">
            <p class="text-gray-700 mb-2">
                ...
                @if (isset($contactMessage))
                    <span class="font-semibold">{{ $contactMessage->name }}</span>
                @else
                    <span id="delete_message_name" class="font-semibold"></span>
                @endif
                ?
            </p>
            <p class="text-sm text-gray-600">
                Tindakan ini tidak dapat dibatalkan. Pesan akan dihapus secara permanen dari database.
            </p>
        </div>
