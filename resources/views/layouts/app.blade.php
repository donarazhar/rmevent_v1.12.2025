        ...
        <div class="container mx-auto px-4">
            ...
            <div x-show="mobileMenuOpen" x-cloak x-transition class="md:hidden pb-4">
                <div class="space-y-2">
                    ...
                    <a href="{{ route('testimonials') }}" :class="scrolled ? 'text-gray-700' : 'text-white'"
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-blue-100">
                        <li class="flex items-start space-x-3">
                            ...
                            <span>Jl. Sisingamangaraja, Keb-Baru, Jakarta Selatan 12110</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            ...
                            <span>masjidagungalazhar@gmail.com</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
